...
import (
	...
	"vigilantMonitor/monitoring/netstatic"
	monitoring "vigilantMonitor/monitoring/unit"
	"vigilantMonitor/server"
	"vigilantMonitor/update"

	"github.com/spf13/cobra"

	pkg_flags "vigilantMonitor/cmd/flags"
)
